...
function formatLink(d) {
	...
	if (d.target.class != "") {
		...
		if (classArray.length > -1) {
			...
			else if (classArray.indexOf("kingly") > -1) {
				returnVal += " kingly";
			}
			else if (classArray.indexOf("priestly") > -1) {
				returnVal += " priestly";
			}
			else if (classArray.indexOf("couply") > -1) {
				returnVal += " couply";
			}
		}
	}
